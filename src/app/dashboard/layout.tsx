...
import { Home, PanelLeft, Settings, FolderKanban, CheckSquare, FileText, Calendar, Users, MessageSquare, Sitemap } from "lucide-react";
...
export default function DashboardLayout({
  ...
  const navLinks = [
    ...
    { href: "/dashboard/schema", label: t.schema, icon: Sitemap },
